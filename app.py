...
# Data lists for storing the scraped data
names_list = []
address_list = []
website_list = []
phones_list = []
...
def main():
    with sync_playwright() as p:
        ...
        # Searching for the desired location
        ...
        for listing in listings:
            ...
            # Print the details of the current listing
            print("Name:", names_list[-1] if names_list else "N/A")
            print("Address:", address_list[-1] if address_list else "N/A")
            print("Website:", website_list[-1] if website_list else "N/A")
            print("Phone Number:", phones_list[-1] if phones_list else "N/A")
            print("Reviews Count:", reviews_c_list[-1] if reviews_c_list else "N/A")
            print("Reviews Average:", reviews_a_list[-1] if reviews_a_list else "N/A")
            print("Store Shopping:", store_s_list[-1] if store_s_list else "N/A")
            print("In Store Pickup:", in_store_list[-1] if in_store_list else "N/A")
            print("Store Delivery:", store_del_list[-1] if store_del_list else "N/A")
            print("Place Type:", place_t_list[-1] if place_t_list else "N/A")
            print("Opens At:", open_list[-1] if open_list else "N/A")
            print("Introduction:", intro_list[-1] if intro_list else "N/A")
            print("-" * 50)
...
if __name__ == "__main__":
    ...
    if args.search:
        ...
        search_for = "Engineering colleges at Moodbidri"
    if args.total:
        total = args.total
    else:
        total = 1
